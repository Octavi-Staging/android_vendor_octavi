...
OCTAVI_VERSION := OctaviOS-$(OCTAVI_BUILD_VERSION)-$(OCTAVI_BUILD)-$(BUILD_DATE)-VANILLA-$(OCTAVI_BUILD_TYPE)
ifeq ($(WITH_GAPPS), true)
OCTAVI_VERSION := OctaviOS-$(OCTAVI_BUILD_VERSION)-$(OCTAVI_BUILD)-$(BUILD_DATE)-GAPPS-$(OCTAVI_BUILD_TYPE)
endif
